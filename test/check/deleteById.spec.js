...
describe("GET CHECK DATA by id get api/check/${id}", () => {
  let name;
  let userData;
  let tempToken;
  let otp;
  ...
  describe("Delete the check by id", () => {
    describe("remove the check", () => {
      ...
      describe("with invalid check id", () => {
        ...
        it("check not exits", () => {
          return request
            .delete(`/api/check/${mongoose.Types.ObjectId()}`)
            .set({ authorization: token })
            .send()
            .then((response) => {
          ...
          return request
            ...
            .then((response) => {
              ...
              expect(response.body)
                .be.a("object")
                .to.have.property("message")
                .to.equal("Check deleted successfully");
            });
        });
      });
    });
