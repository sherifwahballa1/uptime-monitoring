...
describe("PAUSE OR ACTIVE CHECK POST api/check/pause/${id}", () => {
  let name;
  let userData;
  let tempToken;
  let otp;
  ...
  describe("Toggle the check", () => {
    describe("active or pause check", () => {
      describe("Without credentials", () => {
        it("try to create without headers (Authorization)", () => {
          return request
            .post(`/api/check/pause/${checkId}`)
            .send()
            .then((response) => {
      ...
      describe("toggle check", () => {
        ...
        it("check not exits", () => {
          return request
            .post(`/api/check/pause/${mongoose.Types.ObjectId()}`)
            .set({ authorization: token })
            .send()
            .then((response) => {
